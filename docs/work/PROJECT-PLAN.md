...
Each milestone shows BOTH engineering work (what to build) AND validation work (what to prove).

---

### M1: Foundation Validated (Target: +3 weeks)

**Exit criteria**: A1-A4 show positive signal, platform instrumented for measurement

#### Engineering Work (Build)

| Item | Owner | Status | Blocks |
|------|-------|--------|--------|
| Apply pending migrations | data-engineer | 🔄 In Sprint | Schema stability |
| PostHog Quick Start events | frontend-dev | 🔄 In Sprint | A2 measurement |
| PostHog HITL approval events | frontend-dev | 🔄 In Sprint | A1 measurement |
| Schema: Trial split migration | data-engineer | ⏳ Backlog | US-FT03, US-FT04 |

#### Validation Work (Prove)

| Item | Owner | Status | Assumption |
|------|-------|--------|------------|
| WTP pricing survey | product-strategist | 🔄 In Sprint | A4 |
| Analyze Quick Start conversion | data-analyst | ⏳ Pending | A2 |
| Analyze HITL trust signals | data-analyst | ⏳ Pending | A1 |
...
**Exit criteria**: >20% landing page conversion, WTP confirmed, desirability experiments running

#### Engineering Work (Build)

| Item | Owner | Status | Blocks |
|------|-------|--------|--------|
| **Epic 5: Template Library** | ui-designer, frontend-dev | ⏳ Backlog P1 | Landing page generation |
| **Epic 6: Agent Tools Integration** | ai-engineer | ⏳ Backlog P1 | Ad creative generation |
...
| Consultant Trial mock client | frontend-dev | ⏳ Backlog P1 | A6 testing |
| HITL Approval UI data source | backend-dev | ⏳ Backlog P1 | Trust improvement |

#### Validation Work (Prove)

| Item | Owner | Status | Assumption |
|------|-------|--------|------------|
| Landing page A/B test | content-strat | ⏳ Backlog P1 | A5, A7 |
| IH community launch | content-strat | ⏳ Backlog P1 | A8 |
| Consultant marketing test | content-strat | ⏳ Backlog P1 | A6 |

#### Blocked (External Dependencies)

| Item | Blocker | Impact |
|------|---------|--------|
| Stripe integration | No Stripe account | Can't capture revenue |
| Ad Platform OAuth | No business accounts | Can't run ad experiments |
...
**Exit criteria**: E2E journey <10min, Modal SLOs met, full journey works

#### Engineering Work (Build)

| Item | Owner | Status | Blocks |
|------|-------|--------|--------|
| E2E journey completion | qa-engineer | ⏳ Backlog P2 | Journey verification |
| Modal reliability SLOs | platform-eng | ⏳ Backlog P2 | Production stability |
| Performance benchmarks | system-architect | ⏳ Backlog P2 | Response times |
| E2E tests: Billing (US-B01-B10) | qa-engineer | ⏳ Backlog P2 | Payment flows |
| E2E tests: Consultant Trial | qa-engineer | ⏳ Backlog P2 | Consultant flows |

#### Validation Work (Prove)

| Item | Owner | Status | Assumption |
|------|-------|--------|------------|
| Dogfood complete journey | qa-engineer | ⏳ Pending | Technical feasibility |
| Time founder journey | data-analyst | ⏳ Pending | <10min target |
...
| Item | Owner | Status | Blocks |
|------|-------|--------|--------|
| Pricing tiers implemented | frontend-dev, backend-dev | ⏳ Backlog P1 | Monetization |
| Stripe webhooks complete | backend-dev | ⏳ Blocked | Payment processing |
| Upgrade/downgrade flows | frontend-dev | ⏳ Backlog P1 | Plan changes |

#### Validation Work (Prove)

| Item | Owner | Status | Assumption |
|------|-------|--------|------------|
| First customer acquisition | product-strategist | ⏳ Pending | Market exists |
| Pricing validation | product-strategist | ⏳ Pending | A4 confirmed |
...
#### Engineering Work (Build) - Gated

| Item | Owner | Status | Blocks |
|------|-------|--------|--------|
| Schema: relationship_type | data-engineer | ⏳ Gated | Cohort support |
| Configurable invite flows | frontend-dev | ⏳ Gated | Relationship types |
| Cohort-specific dashboards | frontend-dev | ⏳ Gated | Portfolio views |

#### Validation Work (Prove) - Can Start Anytime

| Item | Owner | Status | Assumption |
|------|-------|--------|------------|
| A11: Cohort priority | product-strategist | ⏳ Gated behind A6 | Which cohort first |
| A9: WTP validation | product-strategist | ⏳ Gated behind A11 | Will they pay |
| A10: Distribution validation | product-strategist | ⏳ Gated behind A9 | Will they mandate |
