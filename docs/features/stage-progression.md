...
deprecated_by: "ADR-006 Quick Start Architecture"
---

# Stage Progression System

> **DEPRECATED (2026-01-19)**: This document describes the legacy 7-stage AI conversation system which has been replaced by Quick Start. See [ADR-006](../../../startupai-crew/docs/adr/006-quick-start-architecture.md).
>
> **Quick Start** replaces the 7-stage conversation with a single form input (30 seconds, $0 AI cost, 100% deterministic). The Founder's Brief is now generated by Phase 1 AI research, not collected during onboarding.
>
...
The legacy onboarding journey consisted of 7 stages. Users progressed through stages as they covered required topics in conversation with Alex (the AI guide). Progression was determined by topic coverage, not tool calls.

> **Architecture**: See [ADR-004: Two-Pass Onboarding](../../../startupai-crew/docs/adr/004-two-pass-onboarding-architecture.md) (also deprecated for Phase 0)
