...
function Sidebar({
  ...
  if (collapsible === "none") {
    return (
      <div
        className={cn(
          "flex h-full w-64 flex-col bg-gray-50 border-r",
          className
        )}
        {...props}
      >
...
function SidebarGroupLabel({
  ...
  return (
    <Comp
      className={cn(
        "flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium text-gray-600 outline-none transition-[margin,opacity] duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
        className
      )}
      {...props}
    />
