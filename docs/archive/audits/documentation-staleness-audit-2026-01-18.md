...
| `user-experience/journeys/founder/founder-journey-map.md` | 2025-11-30 | 49 days | Two-Pass Architecture changes UX flow |
...
user-experience/journeys/founder/founder-journey-map.md
...
| P2 | `user-experience/journeys/founder/founder-journey-map.md` | Update for Two-Pass flow | 2h |
