...
### 🟢 Current & Active
1. **[status/MIGRATION_COMPLETE.md](./status/MIGRATION_COMPLETE.md)** - ✅ Client migration + recent auth fixes (2025-11-13)
2. **[status/MIGRATION_SUMMARY.md](./status/MIGRATION_SUMMARY.md)** - ✅ Technical migration details + routing architecture

### 🔴 Critical - Read First
3. **[incidents/ONBOARDING_FAILURE_ANALYSIS.md](./incidents/ONBOARDING_FAILURE_ANALYSIS.md)** - Current system failures
4. **[overview/ONBOARDING_TO_CREWAI_ARCHITECTURE.md](./overview/ONBOARDING_TO_CREWAI_ARCHITECTURE.md)** - Implementation plan to fix
5. **[overview/CONSULTANT_VS_FOUNDER_CLARIFICATION.md](./overview/CONSULTANT_VS_FOUNDER_CLARIFICATION.md)** - User role ambiguity analysis

### 🟡 Architecture & Planning
6. **[overview/ARCHITECTURE_RECOMMENDATIONS.md](./overview/ARCHITECTURE_RECOMMENDATIONS.md)** - Long-term Option B vision
7. **[incidents/SYSTEM_ENGINEER_HANDOFF.md](./incidents/SYSTEM_ENGINEER_HANDOFF.md)** - ⚠️ Historical context (most issues resolved)

### 🟢 Testing & Quality
8. **[testing/E2E_TEST_IMPLEMENTATION.md](./testing/E2E_TEST_IMPLEMENTATION.md)** - Playwright E2E test infrastructure
9. **[testing/TESTING_CHECKLIST.md](./testing/TESTING_CHECKLIST.md)** - Testing workflow and procedures

### 🟢 Reference
10. **[specs/auth.md](./specs/auth.md)** - Authentication specification
11. **[specs/mvp-specification.md](./specs/mvp-specification.md)** - MVP feature specifications
12. **[specs/JTBD_AI_AGENTS.md](./specs/JTBD_AI_AGENTS.md)** - AI agent jobs-to-be-done specification
13. **[specs/AI_AGENT_INTERACTION_SPEC.md](./specs/AI_AGENT_INTERACTION_SPEC.md)** - AI agent interaction patterns
14. Additional documentation:
   - `features/stage-progression.md` - Onboarding stage system design
   - `incidents/TROUBLESHOOTING.md` - Common issues and solutions

---

## 📋 Document Summaries

### 1. incidents/ONBOARDING_FAILURE_ANALYSIS.md
...
### 2. overview/ONBOARDING_TO_CREWAI_ARCHITECTURE.md
...
### 3. overview/ARCHITECTURE_RECOMMENDATIONS.md
...
### 4. incidents/SYSTEM_ENGINEER_HANDOFF.md
...
### 6. testing/E2E_TEST_IMPLEMENTATION.md
...
### 7. overview/CONSULTANT_VS_FOUNDER_CLARIFICATION.md
...
**Documentation Updated:** `status/MIGRATION_COMPLETE.md`, `status/MIGRATION_SUMMARY.md`
...
**Files Modified:**
- `frontend/src/pages/dashboard.tsx` → `frontend/src/pages/consultant-dashboard.tsx`
- `frontend/src/lib/auth/roles.ts` - Updated ROLE_REDIRECTS
- `frontend/src/components/auth/LoginForm.tsx` - Added role-based redirect logic
- `frontend/src/app/auth/callback/route.ts` - Removed hardcoded fallbacks
- `frontend/src/pages/settings.tsx` - Fetch real user profile
- `frontend/src/components/layout/AppSidebar.tsx` - Updated navigation links
